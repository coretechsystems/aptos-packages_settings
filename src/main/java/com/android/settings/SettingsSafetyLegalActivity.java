...
public class SettingsSafetyLegalActivity extends AlertActivity implements OnCancelListener, OnClickListener {
    ...
    private void showErrorAndFinish(String url) {
        if (this.mErrorDialog == null) {
            this.mErrorDialog = new Builder(this).setTitle(R.string.settings_safetylegal_activity_title).setPositiveButton(17039370, this).setOnCancelListener(this).setCancelable(true).create();
        } else if (this.mErrorDialog.isShowing()) {
            this.mErrorDialog.dismiss();
        }
        this.mErrorDialog.setMessage(getResources().getString(R.string.settings_safetylegal_activity_unreachable, new Object[]{url}));
