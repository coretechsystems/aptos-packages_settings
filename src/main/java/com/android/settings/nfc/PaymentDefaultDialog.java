        ...
        if (component == null || category == null) {
            ...
            if (defaultComponent == null || !defaultComponent.equals(component)) {
                ...
                if (defaultPaymentApp == null) {
                    p.mMessage = String.format(getString(R.string.nfc_payment_set_default), new Object[]{sanitizePaymentAppCaption(requestedPaymentApp.caption.toString())});
                } else {
                    p.mMessage = String.format(getString(R.string.nfc_payment_set_default_instead_of), new Object[]{sanitizePaymentAppCaption(requestedPaymentApp.caption.toString()), sanitizePaymentAppCaption(defaultPaymentApp.caption.toString())});
                }
